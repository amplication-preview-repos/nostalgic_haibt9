...
@InputType()
class CurriculumModuleCreateNestedManyWithoutDegreeSpecialtiesInput {
...
export { CurriculumModuleCreateNestedManyWithoutDegreeSpecialtiesInput as CurriculumModuleCreateNestedManyWithoutDegreeSpecialtiesInput };
